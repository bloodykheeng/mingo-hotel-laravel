...
<head>
    ...
    <title>Room Booking Updated - Mingo Hotel Kayunga</title>
    <style>
        /* Email Styles */
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            <h1>Room Booking Update Notification</h1>
        </div>
        ...
        <div class="email-content">
            ...
            <div class="update-notice">
                <p><strong>A room booking has been updated</strong> by {{ $updatedBy->name }} ({{ $updatedBy->email }}).
                </p>
            </div>
            ...
            <div class="booking-details">
                ...
                <div class="detail-row">
                    ...
                    <span>{{ $roomBooking->updated_at->format('F j, Y g:i A') }}</span>
                </div>
            </div>
